...
public class SeatSelectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //initializing all the seat buttons
        ...
        prcd=findViewById(R.id.proceed);
        ...
        prcd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (seats_counter>0) {
                    ...
                    i.putExtra("numberOfSeats",seats_counter);//Sending number of seats forward
                    startActivity(i);
                }
                else
                    Toast.makeText(SeatSelectionActivity.this,"Select atleast one seat.",Toast.LENGTH_SHORT).show();
            }
        });
        //A1 button listener
